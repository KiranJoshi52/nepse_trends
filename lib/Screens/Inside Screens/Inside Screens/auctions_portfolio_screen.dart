...
class AuctionsPortfolioScreen extends StatefulWidget {
  const AuctionsPortfolioScreen({super.key});

  @override
  _AuctionsPortfolioScreenState createState() =>
      _AuctionsPortfolioScreenState();
}

class _AuctionsPortfolioScreenState extends State<AuctionsPortfolioScreen> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Auction transaction saved successfully!')),
      );
    }
  }
}
